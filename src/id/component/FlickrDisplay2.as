package id.component
{
	 ...
	 */
	public class FlickrDisplay2 extends TouchComponent
	{
		private var media:*;
		 ...
		 *
		 */
		public function FlickrDisplay2()
		{
			super();
		...
		override protected function createUI():void
		{
			...
			// Data			
			mediaUrl=FlickrParser2.dataSet[id].imgUrl;
			thumbUrl=FlickrParser2.dataSet[id].imgUrl;
			qrCodeTag=FlickrParser2.dataSet[id].qrCodeTag;
			titleText=FlickrParser2.dataSet[id].title;
			descriptionText=FlickrParser2.dataSet[id].description;
			usernameText=FlickrParser2.dataSet[id].author;
			tagText=FlickrParser2.dataSet[id].publish;

			if (video)
			{
				videoSource=FlickrParser2.dataSet[_id].videoSource;
			}
